...
export default function Card001() {
    return (
        ...
        <div class="ml-3 mt-10 mr-3 w-80 max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-blue-600 dark:border-gray-100 hover:bg-blue-700 ">
            <div className='flex'>
                <svg className='' width="60px" height="60px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00024000000000000003">
            ...
            <p class="mb-2  ml-3 font-normal text-gray-500 dark:text-white text-2xl ">Rs: 1124.70</p>

            <a href="/" class="ml-3 inline-flex font-medium items-center text-white hover:underline hover:text-slate-100">
                See Tables
