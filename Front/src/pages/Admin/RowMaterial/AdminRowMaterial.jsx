                ...
                <table className="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        {currentRows.map((product) => (
                            <tr key={product.id} className="text-black bg-[#cdf8da] border-b border-[#4bf885] hover:bg-[#a1f0c6]">
                                ...
                                <td className="px-6 py-3">
                                    ...
                                    <button className="px-3 py-1 font-medium text-white bg-red-600 rounded hover:bg-red-700" onClick={() => handleRemove(product.id)}>
                                        Remove
                                    </button>
                                </td>
                            </tr>
