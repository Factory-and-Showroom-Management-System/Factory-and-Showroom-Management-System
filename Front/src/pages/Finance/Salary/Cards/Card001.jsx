...
export default function Card001() {
    ...
    return (
        <div className="ml-3 mt-10 mr-3 w-80 max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-blue-600 dark:border-gray-100 hover:bg-blue-700">
            <div className='flex'>
                ...
                <label className="mt-4 ml-3 font-semibold text-gray-800 dark:text-white text-3xl">Net Pay</label>
            </div>
            <p className="mb-2 ml-3 font-normal text-gray-500 dark:text-white text-2xl">Rs: {totalNet.toFixed(2)}</p>
            <a href="/" className="ml-3 inline-flex font-medium items-center text-white hover:underline hover:text-slate-100">
                See Tables
